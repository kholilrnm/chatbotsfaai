                ...
                if (regex.test(receivedText) || mentionedMe) { 
                    ...
                    if (isImage) {
                        ...
                        try {
                            ...
                            const response = await axios.post('https://fastapi-production-e1b4.up.railway.app/api-img', {
                                image: base64Image,    
                        ...
                        try {
                            ...
                            const response = await axios.post('https://fastapi-production-e1b4.up.railway.app/api-txt', {
                                text: receivedText,
                            });
